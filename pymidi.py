...
def main():
    ...
    instrument = 127 # set_instrument(instrument_id, channel=0) | You can find a list of all MIDI Level 1 instruments at the end of this code.
    ...
    # play a note.
    midi_out.note_on(note=53, velocity=127) # turns a midi note on (note must be off) | note_on(note, velocity=None, channel=0)
    midi_out.note_off(note=53, velocity=0) # turns a midi note off (note must be on)
